...
export default function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:max-w-sm z-50 animate-in slide-in-from-bottom-2">
      <Card className="bg-white border-2 border-[var(--electric-blue)] shadow-xl">
        <CardContent className="p-4">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 bg-[var(--electric-blue)] rounded-lg flex items-center justify-center flex-shrink-0">
              <Smartphone className="w-5 h-5 text-white" />
            </div>
            
            <div className="flex-1 min-w-0">
              <h4 className="font-heading font-semibold text-gray-900 mb-1">
                Install ElectriSafe App
              </h4>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className="bg-[var(--electric-blue)] hover:bg-[var(--dark-navy)] text-white flex-1"
                >
