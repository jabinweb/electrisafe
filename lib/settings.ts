...
const defaultSettings: SiteSettings = {
  general: {
    ...
    siteDescription: 'Safe Power for Every Space',
    siteUrl: 'https://electrisafe.in',
    contactEmail: 'info@electrisafe.in',
    contactPhone: '+91 95655 55581',
  ...
  email: {
    ...
    smtpUser: '',
    smtpPassword: '',
    smtpFromName: 'ElectriSafe Power Solutions',
    smtpFromEmail: 'info@electrisafe.in',
    adminEmails: ['info@electrisafe.in']
  },
  seo: {
    metaTitle: 'ElectriSafe Power Solutions - Professional Electrical Services in Lucknow',
